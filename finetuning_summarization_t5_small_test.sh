#!/bin/sh
#SBATCH --job-name=finetuning_summarization_full_0.2
...
dataset_prop=0.2 # how much of the dataset to use (as a fraction not a percentage)
...
unique_save_name="t5-small_"$dataset_prop"_test_new_folder"
