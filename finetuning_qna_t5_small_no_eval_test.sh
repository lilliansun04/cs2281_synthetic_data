...
dataset_prop=0.01 # how much of the dataset to use (as a fraction not a percentage)
...
unique_save_name="t5-small_"$dataset_prop"_test"
...
echo "Running finetuning_qna_no_eval.py"
...
python -u $CODE_DIR/finetuning_qna_no_eval.py $model_name $output_dir $scratch_dir $unique_save_name $dataset_prop $qna_train_filepath $qna_val_filepath $qna_test_filepath $batch_size $eval_steps
echo "DONE"