...
unique_save_name="t5-small_"$dataset_prop"_no_eval_seed_"$SLURM_ARRAY_TASK_ID
...
python -u $CODE_DIR/finetuning_summarization_no_eval.py $model_name $output_dir $scratch_dir $unique_save_name $dataset_prop $summarization_train_filepath $summarization_val_filepath $summarization_test_filepath $batch_size $eval_steps $random_seed
echo "DONE"